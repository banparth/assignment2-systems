...
def weighted_sum_fwd(
    ...
    for i in range(tl.cdiv(D, D_TILE_SIZE)):
        ...
        weight_block_ptr = weight_block_ptr.advance((D_TILE_SIZE,)) # Move
...
x = torch.rand(128, 128, device=device, requires_grad=True)
w = torch.rand(128, device=device, requires_grad=True)
